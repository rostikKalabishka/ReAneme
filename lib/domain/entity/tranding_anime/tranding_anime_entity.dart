...
part 'tranding_anime_entity.g.dart';
...
class TrendingAnimeEntity {
  ...
  factory TrendingAnimeEntity.fromJson(Map<String, dynamic> json) =>
      _$TrendingAnimeEntityFromJson(json);
  Map<String, dynamic> toJson() => _$TrendingAnimeEntityToJson(this);
}
